...
public class UserController {
    ...
    // 로그인처리
    @PostMapping("/login")
    public String login(@Valid @ModelAttribute("userLoginForm") UserLoginForm form, BindingResult bindingResult, HttpSession session) {
        ...
        LoginUser loginUser = new LoginUser(user.getUserId(), user.getLoginId(), user.getName(), user.getRole());
