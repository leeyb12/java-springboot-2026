        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers(  // URL별 접근권한 설정
                    ...
                    "/trumbowyg/**",
                    "/upload/**",
                    "/oauth2/**",  // 240429. 소셜로그인 URL도 아무때나 접속권한
                    "/login/oauth2/**"
                ).permitAll()   // 인증없이 누구나 접근 가능
            ...
            .addFilterBefore(  // 필터 배치. ID/Password 확인 필터 전 우리가만든 JWT필터 먼저 실행
