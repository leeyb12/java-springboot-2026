...
public class StudyPostService {
    ...
    @Autowired
    private StudyApplicationMapper studyApplicationMapper;
    ...
    public void deletePost(Long postId) {
        // 같은 postId의 Comment 삭제
        this.commentMapper.deleteComment(postId);

        // 같은 postId의 StudyApplication 삭제
        this.studyApplicationMapper.deleteApplicationByPostId(postId);
