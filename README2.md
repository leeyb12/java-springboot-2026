...
- Visual Studio Code 확장
    ...
    - Spring Initializer Java Support 설치 확인
...
2. Spring Initializer: Specify Spring Boot Version
...
- build.gradle : 자바버전, 플러그인, 의존성 설정 파일 - [소스](./Day03/demo/build.gradle)
    ...
    version = '0.0.1-SNAPSHOT'  // 프로젝트 버전. 실제 배포시는 1.0.0으로 변경
...
- 어노테이션 목록
  ...
  - @GetMapping, @PostMapping : 웹 매핑 종류 결정
...
- 사용법
  ...
  ```java
  @RequestMapping(value = "/create", method=RequestMethod.GET)  // RequestMethod.POST 도 사용
  ```
