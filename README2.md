...
- 웹 기술 히스토리
  ...
  - `JSP`(Java Server Page) : HTML과 Java소스를 분리. 쉽게 개발하도록 만든 기숧(난이도 중)
    - 개발환경 구성 난이도가 높음
...
- 어노테이션 목록
  ...
  - @ResponseBody : 응답페이지에 텍스트 출력 어노테이션, 자바의 String 문자열 자동 생성된 웹페이지에 렌더링 작업
...
- 게시글 수정
  ...
  - BoardController에 /modify/{bno} GetMapping, PostMapping 작업 - [소스](./Day07/webboard/src/main/java/com/pknu26/webboard/controller/BoardController.java)
...
<img src="image-26.png" width="800px" />
...
<img src="image-27.png" width="800px" />
...
<img src="image-28.png" width="800px" />
...
<img src="image-29.png" width="800px" /> 
...
- [bootstrampmade](https://bootstrapmade.com/)
